// Расчет стоимости для Москва → Новосибирск
...
const config = {
  ...
  tariffs: {
    ...
    '5т': 0,        // Отсутствует - будет рассчитываться
    '10т': 65.1,    // Из конфига
    '20т': 73.8,    // Из конфига
...
const tariff15t = calculateTariffWithRule('1.5т');
const tariff3t = calculateTariffWithRule('3т');
const tariff5t = calculateTariffWithRule('5т');
...
// Вывод результатов
console.log('РАСЧЕТ СТОИМОСТИ: Москва → Новосибирск');
console.log('Используется Вариант 4 (линейная интерполяция)');
console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
console.log('');

console.log('ТАРИФЫ (рассчитаны через коэффициенты):');
const base20tRate = config.tariffs["20т"];
console.log(`  20т:  ${tariff20t.toFixed(2)} ₽/км (из конфига)`);
console.log(`  10т:  ${tariff10t.toFixed(2)} ₽/км (из конфига)`);
console.log(`  5т:   ${tariff5t.toFixed(2)} ₽/км (${base20tRate.toFixed(1)} × 0.76)`);
console.log(`  3т:   ${tariff3t.toFixed(2)} ₽/км (${base20tRate.toFixed(1)} × 0.33)`);
console.log(`  1.5т: ${tariff15t.toFixed(2)} ₽/км (${base20tRate.toFixed(1)} × 0.22)`);
console.log(`  500кг: ${tariff500kg.toFixed(2)} ₽/км (${base20tRate.toFixed(1)} × 0.15)`);
console.log('');
