        ...
        <div className="flex items-center justify-between">
          ...
          >
            ...
            <div className="flex flex-col">
              ...
              <p className="text-sm md:text-base font-light tracking-wide text-muted-foreground whitespace-nowrap">транспортная компания</p>
            </div>
          </button>
          
          {/* Desktop Navigation - скрыто на мобильных */}
          <nav className="hidden lg:flex items-center gap-2" style={{backgroundColor: '#E5E7EB', borderRadius: '25px'}}>
            {navItems.map((item) => (
              <button
                key={item.id}
                onClick={item.action}
          ...
          <div className="hidden lg:flex flex-col items-end gap-2">
            ...
            <a href="https://wa.me/79299882201" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-primary transition-colors">
